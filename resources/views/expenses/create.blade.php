    ...
    <div class="bg-white dark:bg-gray-800 shadow-md rounded-lg overflow-hidden mx-auto">
        <form action="{{ route('expenses.store') }}" method="POST" class="p-6">
            ...
            <div class="mt-6 flex justify-end">
                ...
                <button type="submit"
                    class="px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-indigo-600 hover:bg-indigo-700">{{ __('messages.save_expense') }}</button>
            </div>
        </form>
    </div>
</x-app-layout>