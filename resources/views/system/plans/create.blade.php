<x-app-layout>
    ...
    <div class="max-w-4xl mx-auto py-6">
        <div class="bg-white/70 dark:bg-gray-800/70 backdrop-blur-xl shadow-xl shadow-gray-200/50 dark:shadow-black/20 rounded-3xl border border-white/40 dark:border-gray-700 overflow-hidden">
            <form action="{{ route('plans.store') }}" method="POST" class="p-8 md:p-10">
                @csrf
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="name" value="{{ old('name') }}" required placeholder="e.g. Premium Plan"
                    ...
                    <div>
                        ...
                        <input type="text" name="slug" value="{{ old('slug') }}" required placeholder="premium"
                            class="block w-full bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 text-gray-900 dark:text-white focus:border-primary focus:ring-2 focus:ring-primary/20 rounded-xl shadow-sm transition-all font-mono" />
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="description" rows="3" placeholder="Brief description of who this plan is for..."
                            class="block w-full bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 text-gray-900 dark:text-white focus:border-primary focus:ring-2 focus:ring-primary/20 rounded-xl shadow-sm transition-all">{{ old('description') }}</textarea>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="number" step="0.01" name="price" value="{{ old('price') }}" required placeholder="999.00"
                                class="pl-9 block w-full bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 text-gray-900 dark:text-white focus:border-primary focus:ring-2 focus:ring-primary/20 rounded-xl shadow-sm transition-all font-bold text-lg" />
                        </div>
                    ...
                    <div>
                        ...
                        <input type="number" name="customer_limit" value="{{ old('customer_limit') }}" placeholder="e.g. 500"
                            class="block w-full bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 text-gray-900 dark:text-white focus:border-primary focus:ring-2 focus:ring-primary/20 rounded-xl shadow-sm transition-all" />
                    </div>
                    ...
                    <div>
                        ...
                        <input type="number" name="trial_days" value="{{ old('trial_days') }}" placeholder="e.g. 14"
                            class="block w-full bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 text-gray-900 dark:text-white focus:border-primary focus:ring-2 focus:ring-primary/20 rounded-xl shadow-sm transition-all" />
                    </div>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <input type="text" name="features" value="{{ old('features') }}" placeholder="Unlimited Staff, Custom Reports, Priority Support"
                            class="block w-full bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 text-gray-900 dark:text-white focus:border-primary focus:ring-2 focus:ring-primary/20 rounded-xl shadow-sm transition-all" />
                    </div>
