            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" name="customer_id" id="customer_id"
                        ...
                        class="mt-1 block w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 bg-gray-50 focus:border-indigo-500 rounded-md shadow-sm"
                        readonly>
                </div>
                ...
                <div>
                    ...
                    <select name="status" id="status"
                        class="mt-1 block w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 rounded-md shadow-sm">
                        <option value="Active" {{ old('status', $customer->status) == 'Active' ? 'selected' : '' }}>Active
                        </option>
                ...
                <div>
                    ...
                    <select name="payment_frequency" id="payment_frequency"
                        class="mt-1 block w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 rounded-md shadow-sm">
                        <option value="Daily" {{ old('payment_frequency', $customer->payment_frequency) == 'Daily' ? 'selected' : '' }}>Daily</option>
                        <option value="Weekly" {{ old('payment_frequency', $customer->payment_frequency) == 'Weekly' ? 'selected' : '' }}>Weekly</option>
                        <option value="Monthly" {{ old('payment_frequency', $customer->payment_frequency) == 'Monthly' ? 'selected' : '' }}>Monthly</option>
                    </select>
                ...
                <div>
                    <label for="customer_photo"
                        class="block font-medium text-sm text-gray-700 dark:text-gray-300">Update Photo</label>
                    ...
                    @if($customer->customer_photo)
                        <div class="mt-2">
                            <img src="{{ asset('storage/' . $customer->customer_photo) }}" alt="Current Photo"
            ...
            <div class="mt-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <textarea name="address" id="address" rows="3"
                        class="mt-1 block w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 rounded-md shadow-sm">{{ old('address', $customer->address) }}</textarea>
                ...
                <div>
                    ...
                    <textarea name="delivery_address" id="delivery_address" rows="3"
                        class="mt-1 block w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 rounded-md shadow-sm">{{ old('delivery_address', $customer->delivery_address) }}</textarea>
